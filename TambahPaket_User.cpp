...
//     int opsiLokasi =
//         inputAngka("Pilih opsi lokasi tujuan (1-2): ");
...
//     int opsiTipe =
//         inputAngka("Pilih opsi tipe barang (1-4): ");
...
//     int pembayaran =
//         inputAngka("Pilih metode pembayaran (1-2): ");
...
//     paket[jumlahPaket].pemilik =
//         userAktif;

//     if (pembayaran == 1) {

//         paket[jumlahPaket].pembayaran =
//             "COD";

//         paket[jumlahPaket].status =
//             "Diproses";
